...
{
    public class FiatDepositCondition : ConditionBase
    {
        ...
        public override ConditionType Type { get; set; } = ConditionType.FiatDepositCondition;
        ...
        public FiatDepositCondition()
        {
        }
        public FiatDepositCondition(string campaignId, Dictionary<string, string> parameters, List<RewardBase> rewards, string conditionId, TimeSpan timeToComplete, ActionEnum action, int weight, string descriptionTemplateId)
        {
            Type = ConditionType.DepositCondition;
            ConditionId = conditionId ?? Guid.NewGuid().ToString("N");
            
            CampaignId = campaignId;
            EventTypes = new List<EventType>() { EventType.FiatDepositMade };
